...
const calculateChessboardMap = (pawns: PawnProps[]): number[][] => {
...
const isSameColor = (pawn: PawnProps, pawnIndex: number): boolean => {
    return (pawnIndex < 12 && pawn.color === "black") || (pawnIndex >= 12 && pawn.color === "white");
};
