        ...
        <div style={{ fontSize: "18px" }}>
          <ul style={{ textAlign: "left" }}>
            ...
            <li>
              ...
              <strong style={{ color: "#d27765" }}>{"pawns"}</strong> array on
              the <CodeComponent>Chessboard</CodeComponent>
            </li>
          </ul>

          <p style={{ textAlign: "left", fontSize: "16px" }}>
            Implement the code inside the{" "}
            <CodeComponent>KataCode</CodeComponent> file and child components.
            The <CodeComponent>Pawn</CodeComponent> is already created in the
            components folder but will need some changes.
          </p>
          <p style={{ textAlign: "left", fontSize: "16px" }}>
          ...
          <p style={{ textAlign: "left", fontSize: "16px" }}>
            ...
            <CodeComponent>PawnControls</CodeComponent> that allows to change
            the actual coordinates of a Pawn. This may be useful for testing.
            Use it in your <CodeComponent>Pawn</CodeComponent> component
            implementation.
          </p>
          <p style={{ textAlign: "left", fontSize: "16px" }}>
